    ...
    implements Set<E>, Serializable
{
     ...
     * @param expectedElements The typical number of items you expect to be added to the SimpleBloomFilter (often called
     *            'n').
     */
    ...
    {
        this( byteArrayToInt( rawBitArray, 4 + offset ), byteArrayToInt( rawBitArray, 0 + offset ),
              fromByteArray( new BitSet(), rawBitArray, offset + 8, length - 8 ) );
    }
     ...
     * 
     * @param bitArraySize The number of bits in the bit array (often called 'm' in the context of bloom filters).
     * @param expectedElements he typical number of items you expect to be added to the SimpleBloomFilter (often called
     *            'n').
    ...
    /**
     * Returns a byte array of at least length 8. The most significant bit in the result is guaranteed not to be a 1
