...
/**
 * This is a handle for permanent connections. With this class the permanent
 * connection can be reused or closed. The is only 1 connection allowed for a
 * given destination.
 * 
 * It is important that before Peer.shutdown, all permanent connections are
 * closed. Otherwise shutdown will block forever and will wait until the
 * permanent connection is closed.
 * 
 * @author Thomas Bocek
 * 
 */
public class PeerConnection
{
	...
	/**
	 * Closes and releases the connection from the reservation. Closes the
	...
	/**
	 * @return The destination of the permanent connection. There can only be
	 *         one permanent connection to a destination.
	 */
	...
	/**
	 * @return The channel creator unless the connection is not closed.
	...
	/**
	 * @return The number of milliseconds a connection is considered idle and
	 *         will be closed.
	 */
