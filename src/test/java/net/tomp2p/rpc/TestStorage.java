...
public class TestStorage
{
    ...
    private void testAdd( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            FutureResponse fr =
                smmSender.add( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               dataSet, false, false, true, cc, false, null );
            ...
            SortedMap<Number480, Data> c =
                storeRecv.get( key.getLocationKey(), key.getDomainKey(), Number160.ZERO, Number160.MAX_VALUE );
    ...
    private void testStorePut( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureResponse fr =
                smmSender.put( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               tmp, false, false, false, cc, false, null );
            fr.awaitUninterruptibly();
            System.err.println( fr.getFailedReason() );
            Assert.assertEquals( true, fr.isSuccess() );
            ...
            System.err.println( fr.getFailedReason() );
            Assert.assertEquals( true, fr.isSuccess() );
            Map<Number480, Data> result2 =
                storeRecv.subMap( key.getLocationKey(), key.getDomainKey(), Number160.ZERO, Number160.MAX_VALUE );
    ...
    private void testComparePut( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            fr =
                smmSender.compareAndPut( recv1.getPeerAddress(), new Number160( 33 ),
                                         new ShortString( "test" ).toNumber160(), hashDataMap,
                                         new FutureSuccessEvaluatorCommunication(), false, false, false, false, cc,
                                         false );
            fr.awaitUninterruptibly();
    ...
    @Test
    public void testStorePutIfAbsent()
        throws Exception
    {
    ...
    private void testStorePutIfAbsent( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            fr.awaitUninterruptibly();
            Assert.assertEquals( true, fr.isSuccess() );
            Data c = storeRecv.get( new Number160( 33 ), new ShortString( "test" ).toNumber160(), new Number160( 77 ) );
            for ( int i = 0; i < me1.length; i++ )
                Assert.assertEquals( me1[i], c.getData()[i + c.getOffset()] );
            //
            tmp.clear();
            ...
            fr =
                smmSender.putIfAbsent( recv1.getPeerAddress(), new Number160( 33 ),
                                       new ShortString( "test" ).toNumber160(), tmp, false, false, false, cc, false, null );
            fr.awaitUninterruptibly();
    ...
    private void testStorePutGet( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            // get
            fr =
                smmSender.get( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               tmp.keySet(), null, null, false, false, false, false, cc, false );
            fr.awaitUninterruptibly();
            Assert.assertEquals( true, fr.isSuccess() );
    ...
    private void testStorePutGet2( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            fr =
                smmSender.get( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               null, null, null, false, false, false, false, cc, false );
            fr.awaitUninterruptibly();
            Assert.assertEquals( true, fr.isSuccess() );
            Message m = fr.getResponse();
            Map<Number160, Data> stored = m.getDataMap();
    ...
    @Test
    public void testStorePutRemoveGet()
        throws Exception
    {
    ...
    private void testStorePutRemoveGet( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            // remove
            fr =
                smmSender.remove( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                                  tmp.keySet(), true, false, cc, false );
            fr.awaitUninterruptibly();
            Message m = fr.getResponse();
            Assert.assertEquals( true, fr.isSuccess() );
    ...
    @Test
    public void testStorePutRemoveGet2()
        throws Exception
    {
    ...
    private void testStorePutRemoveGet2( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    private void testStoreGet( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            FutureResponse fr =
                smmSender.add( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               tmp.values(), false, false, false, cc, false, null );
            fr.awaitUninterruptibly();
            // get
            fr =
                smmSender.get( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
    ...
    private void testBigStorePut( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    private void testBigStore2( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        ...
        {
            sender =
                new PeerMaker( new Number160( "0x50" ) ).setP2PId( 55 ).setPorts( 2424 ).setMaxMessageSize( Integer.MAX_VALUE ).makeAndListen();
            sender.getConfiguration().setIdleTCPMillis( Integer.MAX_VALUE );
            recv1 =
                new PeerMaker( new Number160( "0x20" ) ).setP2PId( 55 ).setPorts( 8088 ).setMaxMessageSize( Integer.MAX_VALUE ).makeAndListen();
            ...
            Assert.assertEquals( true, fr.isSuccess() );
            Data data =
                recv1.getPeerBean().getStorage().get( new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                                                      new Number160( 77 ) );
    ...
    private void testBigStoreGet( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            System.err.println( fr.getFailedReason() );
            Assert.assertEquals( true, fr.isSuccess() );
            Assert.assertEquals( 50 * 1024 * 1024,
                                 fr.getResponse().getDataMap().get( new Number160( 77 ) ).getData().length );
        }
        finally
        {
            if ( sender != null )
    ...
    @Test
    public void testBigStoreCancel()
        throws Exception
    {
    ...
    private void testBigStoreCancel( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testBigStoreGetCancel()
        throws Exception
    {
    ...
    private void testBigStoreGetCancel( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testConcurrentStoreAddGet()
        throws Exception
    {
    ...
    private void testConcurrentStoreAddGet( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testResponsibility2()
        throws Exception
    {
        ...
        try
        {
            ...
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureResponse fr =
                master.getStoreRPC().put( master.getPeerAddress(), location, location, dataMap, false, false, false,
                                          cc, false, null );
            fr.awaitUninterruptibly();
    ...
    @Test
    public void testResponsibility3()
        throws Exception
    {
        Random rnd = new Random( 42L );
        Peer master = null;
        ...
        try
        {
            ...
            fcc.awaitUninterruptibly();
            final ChannelCreator cc = fcc.getChannelCreator();
            master.getStoreRPC().put( master.getPeerAddress(), loc, domainKey, contentMap, false, false, false, cc,
                                      false, null ).awaitUninterruptibly();
    ...
    private void testBloomFilter( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            fr =
                smmSender.get( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               null, sbf, null, false, false, false, false, cc, false );
            fr.awaitUninterruptibly();
            Assert.assertEquals( true, fr.isSuccess() );
            Message m = fr.getResponse();
            Map<Number160, Data> stored = m.getDataMap();
    ...
    @Test
    public void testBloomFilterDigest()
        throws Exception
    {
    ...
    private void testBloomFilterDigest( StorageGeneric storeSender, StorageGeneric storeRecv )
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        try
        {
            ...
            fr =
                smmSender.get( recv1.getPeerAddress(), new Number160( 33 ), new ShortString( "test" ).toNumber160(),
                               null, sbf, null, false, true, false, false, cc, false );
            fr.awaitUninterruptibly();
            sender.getConnectionBean().getConnectionReservation().release( cc );
            Assert.assertEquals( true, fr.isSuccess() );
            Message m = fr.getResponse();
