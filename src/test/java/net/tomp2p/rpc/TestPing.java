...
public class TestPing
{
    ...
    @Test
    public void testPingTCPDeadLock2()
        throws Exception
    {
        Peer sender1 = null;
        Peer recv11 = null;
        ...
        {
            final Peer sender =
                new PeerMaker( new Number160( "0x9876" ) ).setP2PId( 55 ).setPorts( 2424 ).makeAndListen();
            sender1 = sender;
            final Peer recv1 =
                new PeerMaker( new Number160( "0x1234" ) ).setP2PId( 55 ).setPorts( 8088 ).makeAndListen();
            recv11 = recv1;
    ...
    @Test
    public void testPingTimeoutTCP()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        ...
        {
            sender = new PeerMaker( new Number160( "0x9876" ) ).setP2PId( 55 ).setPorts( 2424 ).makeAndListen();
            HandshakeRPC handshake =
                new HandshakeRPC( sender.getPeerBean(), sender.getConnectionBean(), new ArrayList<PeerListener>(),
                                  false, true, false );
            recv1 = new PeerMaker( new Number160( "0x1234" ) ).setP2PId( 55 ).setPorts( 8088 ).makeAndListen();
    ...
    @Test
    public void testPingTimeoutTCP2()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testPingTimeoutTCP3()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testPingTimeoutUDP()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testPingReserveLoop()
        throws Exception
    {
        for ( int i = 0; i < 100; i++ )
        {
