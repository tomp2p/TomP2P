...
public class TestMaintenance
{
        ...
        throws Exception
    {
        ...
        {
            master =
                setTime( new PeerMaker( new Number160( rnd ) ).setPorts( 4001 ), true, 1, 1, 1, 1, 1, 1 ).makeAndListen();
    ...
    private Peer[] createNodes( Peer master, int nr, Random rnd, boolean startMaintenance, int... times )
        throws Exception
    {
        ...
        for ( int i = 0; i < nr; i++ )
        {
            peers[i] =
                setTime(
                         new PeerMaker( new Number160( rnd ) ).setEnableMaintenance( startMaintenance ).setMasterPeer( master ),
                         startMaintenance, times ).makeAndListen();
        }
        return peers;
    }
        ...
        throws Exception
    {
        ...
        {
            peers[i] =
                new PeerMaker( new Number160( rnd ) ).setEnableMaintenance( false ).setMasterPeer( master ).makeAndListen();
        }
        return peers;
    }
}
