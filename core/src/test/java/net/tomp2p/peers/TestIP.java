...
public class TestIP {
	...
	public void testMask4() throws UnknownHostException {
		...
		IP.IPv4 v4 = IP.fromInet4Address((Inet4Address)inet);
		InetAddress inet2 = v4.toInet4Address();
	...
	public void testMask6() throws UnknownHostException {
		...
		IP.IPv6 v6 = IP.fromInet6Address((Inet6Address)inet);
		InetAddress inet2 = v6.toInet6Address();
		Assert.assertEquals(inet, inet2);
	}
	
	@Test
	public void testOutboundAddress() {
		IPv4 test4 = IPv4.outboundInterfaceAddress();
		Assert.assertNotEquals(test4, IPv4.WILDCARD);
		IPv6 test6 = IPv6.outboundInterfaceAddress();
		//only works if IPv6 working
		//Assert.assertNotEquals(test6, IPv6.WILDCARD);
	}
	...
	public void testMask4with24() throws UnknownHostException {
		...
		InetAddress inet3 = v4.toInet4Address();
	...
	public void testMask4Set() throws UnknownHostException {
		...
		v4 = IP.fromInet4Address((Inet4Address)inet1);
		...
		InetAddress inet3 = test.toInet4Address();
		Assert.assertEquals(inet2, inet3);
	}
	...
	public void testCalc1() throws UnknownHostException {
		...
		IP.IPv4 mask = IP.fromInet4Address((Inet4Address)InetAddress.getByName("10.0.0.3"));
		mask = mask.maskWithNetworkMask(24);
		IP.IPv4 masked = IP.fromInet4Address((Inet4Address)InetAddress.getByName("0.0.0.2"));
		masked = masked.maskWithNetworkMaskInv(24);
		InetAddress i = mask.set(masked).toInet4Address();
	...
	public void testCalc2() throws UnknownHostException {
		...
		IP.IPv4 masked = IP.fromInet4Address((Inet4Address)InetAddress.getByName("0.0.1.2"));
	...
	public void testCalc3() throws UnknownHostException {
		...
		System.err.println(mask);
		IP.IPv4 masked = IP.fromInet4Address((Inet4Address)InetAddress.getByName("1.2.3.4"));
