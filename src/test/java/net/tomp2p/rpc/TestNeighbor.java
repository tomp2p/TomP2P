...
public class TestNeighbor {
    ...
    public void testNeigbhor() throws Exception {
        ...
        try {
            ...
            FutureResponse fr = neighbors2.closeNeighbors(sender.getPeerAddress(), new Number160("0x30"), null, null,
    ...
    public void testNeigbhorFail() throws Exception {
        ...
        try {
            ...
            ChannelCreator cc = fcc.getChannelCreator();
            try {
                neighbors2.closeNeighbors(sender.getPeerAddress(), new Number160("0x30"), null, null, Type.EXCEPTION,
                        cc, false);
                Assert.fail("");
