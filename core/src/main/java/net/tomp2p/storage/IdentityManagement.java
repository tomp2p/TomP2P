...
public class IdentityManagement implements PeerStatusListener {
    ...
    @Override
    public boolean peerFailed(final PeerAddress peerAddress, final FailReason reason) {
        // don't care, peer can come online again
        return false;
    }

    @Override
    public boolean peerFound(final PeerAddress peerAddress, final PeerAddress referrer) {
