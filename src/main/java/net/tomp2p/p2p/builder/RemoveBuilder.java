    ...
    extends DHTBuilder<RemoveBuilder>
{
    ...
    public FutureDHT start()
    {
        ...
        final FutureDHT futureDHT =
            peer.getDistributedHashMap().remove( locationKey, domainKey, contentKeys, routingConfiguration,
                                                 requestP2PConfiguration, returnResults, signMessage, manualCleanup,
        ...
        implements FutureCreator<FutureDHT>
    {
        ...
        public FutureDHT create()
        {
            final FutureChannelCreator futureChannelCreator =
                peer.reserve( routingConfiguration, requestP2PConfiguration, "remove-builder-direct-replication" );
            final FutureDHT futureDHT =
                peer.getDistributedHashMap().remove( locationKey, domainKey, contentKeys, routingConfiguration,
                                                     requestP2PConfiguration, returnResults, signMessage,
