...
public class TestDHT
{
    ...
    @Test
    public void testTooManyOpenFilesInSystem()
        throws Exception
    {
        Peer master = null;
        Peer slave = null;
    ...
    @Test
    public void testTooManyOpenFilesInSystem2()
        throws Exception
    {
        Peer master = null;
        Peer slave = null;
    ...
    @Test
    public void testBootstrapDiscover()
        throws Exception
    {
        Peer master = null;
        Peer slave = null;
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            slave = new PeerMaker( new Number160( rnd ) ).setPorts( 4002 ).makeAndListen();
            FutureBootstrap fb =
                master.bootstrap().setInetAddress( InetAddress.getByName( "127.0.0.1" ) ).setPorts( 3000 ).start();
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureDHT fdht =
                peers[444].put( peers[30].getPeerID() ).setData( new Number160( 5 ), data ).setRequestP2PConfiguration( pc ).setRoutingConfiguration( rc ).setDomainKey( new ShortString(
                                                                                                                                                                                          "test" ).toNumber160() ).start();
            ...
            // search top 3
            TreeMap<PeerAddress, Integer> tmp =
                new TreeMap<PeerAddress, Integer>(
                                                   peers[30].getPeerBean().getPeerMap().createPeerComparator( peers[30].getPeerID() ) );
            int i = 0;
            for ( Peer node : peers )
            {
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureDHT fdht =
                peers[444].put( peers[30].getPeerID() ).setData( new Number160( 5 ), data ).setDomainKey( new ShortString(
                                                                                                                           "test" ).toNumber160() ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).start();
            fdht.awaitUninterruptibly();
            fdht.getFutureRequests().awaitUninterruptibly();
            Assert.assertEquals( true, fdht.isSuccess() );
            // search top 3
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            fdht =
                peers[555].get( peers[30].getPeerID() ).setDomainKey( new ShortString( "test" ).toNumber160() ).setContentKey( new Number160(
                                                                                                                                              5 ) ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).start();
            fdht.awaitUninterruptibly();
            Assert.assertEquals( true, fdht.isSuccess() );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            {
                fdht =
                    peers[100 + i].get( peers[30].getPeerID() ).setDomainKey( new ShortString( "test" ).toNumber160() ).setContentKey( new Number160(
                                                                                                                                                      5 ) ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).start();
                fdht.awaitUninterruptibly();
                Assert.assertEquals( true, fdht.isSuccess() );
                Assert.assertEquals( 1, fdht.getRawData().size() );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureDHT fdht =
                peers[444].put( peers[30].getPeerID() ).setDomainKey( new ShortString( "test" ).toNumber160() ).setData( new Number160(
                                                                                                                                        5 ),
                                                                                                                         data ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).start();
            fdht.awaitUninterruptibly();
            fdht.getFutureRequests().awaitUninterruptibly();
            Assert.assertEquals( true, fdht.isSuccess() );
            rc = new RoutingConfiguration( 4, 0, 10, 1 );
            pc = new RequestP2PConfiguration( 4, 0, 0 );
            fdht =
                peers[222].remove( peers[30].getPeerID() ).setDomainKey( new ShortString( "test" ).toNumber160() ).setContentKey( new Number160(
                                                                                                                                                 5 ) ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).start();
            fdht.awaitUninterruptibly();
            Assert.assertEquals( true, fdht.isSuccess() );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            fdht =
                peers[222].remove( peers[30].getPeerID() ).setReturnResults().setDomainKey( new ShortString( "test" ).toNumber160() ).setContentKey( new Number160(
                                                                                                                                                                    5 ) ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).start();
            fdht.awaitUninterruptibly();
            Assert.assertEquals( true, fdht.isSuccess() );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            master1 =
                new PeerMaker( new Number160( rnd ) ).setP2PId( 1 ).setConfiguration( c ).setPorts( 4001 ).makeAndListen();
            master2 =
                new PeerMaker( new Number160( rnd ) ).setP2PId( 1 ).setConfiguration( c ).setPorts( 4002 ).makeAndListen();
            master3 =
                new PeerMaker( new Number160( rnd ) ).setP2PId( 1 ).setConfiguration( c ).setPorts( 4003 ).makeAndListen();
            // perfect routing
            ...
            FutureDHT fdht =
                master1.put( id ).setData( new Number160( 5 ), data ).setDomainKey( new ShortString( "test" ).toNumber160() ).setRequestP2PConfiguration( pc ).setRoutingConfiguration( rc ).start();
            fdht.awaitUninterruptibly();
            fdht.getFutureRequests().awaitUninterruptibly();
            ...
            FutureResponse fr =
                master1.getStoreRPC().get( master2.getPeerAddress(), id, new ShortString( "test" ).toNumber160(), tmp,
                                           null, null, false, false, false, false, cc, false );
            fr.awaitUninterruptibly();
            Assert.assertEquals( 1, fr.getResponse().getDataMap().size() );
            fr =
                master1.getStoreRPC().get( master3.getPeerAddress(), id, new ShortString( "test" ).toNumber160(), tmp,
                                           null, null, false, false, false, false, cc, false );
            fr.awaitUninterruptibly();
            Assert.assertEquals( 1, fr.getResponse().getDataMap().size() );
            fr =
                master1.getStoreRPC().get( master1.getPeerAddress(), id, new ShortString( "test" ).toNumber160(), tmp,
                                           null, null, false, false, false, false, cc, false );
            fr.awaitUninterruptibly();
            Assert.assertEquals( 1, fr.getResponse().getDataMap().size() );
            //
            ...
            fdht =
                master1.get( id ).setRoutingConfiguration( rc ).setRequestP2PConfiguration( pc ).setDomainKey( new ShortString(
                                                                                                                                "test" ).toNumber160() ).setContentKey( new Number160(
                                                                                                                                                                                       5 ) ).start();
            fdht.awaitUninterruptibly();
            Assert.assertEquals( true, fdht.isSuccess() );
        ...
        throws Exception
    {
        ...
        {
            master =
                new PeerMaker( new Number160( rnd ) ).setFileMessageLogger( new File( "/tmp/p2plog.txt.gz" ) ).makeAndListen();
    ...
    @Test
    public void testObjectSendExample()
        throws Exception
    {
        Peer p1 = null;
        Peer p2 = null;
    ...
    @Test
    public void testPassiveReplication()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            FutureDHT fdht =
                peers[1].put( peers[50].getPeerID() ).setData( new Data( "test" ) ).setRefreshSeconds( 2 ).setFutureCreate( futureCreate ).start();
            ...
            FutureDHT fdht2 =
                peers[2].remove( peers[50].getPeerID() ).setRefreshSeconds( 1 ).setRepetitions( 5 ).setFutureCreate( futureCreate ).start();
            Timings.sleep( 9 * 1000 );
            Assert.assertEquals( 5, counter.get() );
    ...
    @Test
    public void testActiveReplicationForward()
        throws Exception
    {
        Random rnd = new Random( 42L );
        Peer master = null;
        try
        {
            ...
            // closest
            TreeSet<PeerAddress> tmp =
                new TreeSet<PeerAddress>( master.getPeerBean().getPeerMap().createPeerComparator( locationKey ) );
            ...
            int i = 0;
            while ( !peerClose.getPeerBean().getStorage().contains( locationKey, DHTBuilder.DEFAULT_DOMAIN,
                                                                    Number160.ZERO ) )
            {
                Timings.sleep( 250 );
                i++;
            ...
            FutureResponse futureResponse =
                peers[76].getStoreRPC().get( closest, locationKey, DHTBuilder.DEFAULT_DOMAIN, null, null, null, false,
                                             false, false, false, cc, false );
    ...
    @Test
    public void testActiveReplicationRefresh()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            for ( PeerAddress closest : tmp )
            {
                ...
                ChannelCreator cc = fcc.getChannelCreator();
                FutureResponse futureResponse =
                    master.getStoreRPC().get( closest, locationKey, DHTBuilder.DEFAULT_DOMAIN, null, null, null, false,
                                              false, false, false, cc, false );
                futureResponse.awaitUninterruptibly();
                master.getConnectionBean().getConnectionReservation().release( cc );
                Assert.assertEquals( true, futureResponse.isSuccess() );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureDHT futureDHT =
                master.parallelRequest( locationKey ).setDomainKey( domainKey ).setRequestP2PConfiguration( p2pConfiguration ).setQueue( queue ).setOperation( new Operation()
                                                                                                                                                               {
                                                                                                                                                                   @Override
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 PeerAddress address )
                                                                                                                                                                   {
                                                                                                                                                                       Map<Number160, HashData> hashDataMap =
                                                                                                                                                                           new HashMap<Number160, HashData>();
                                                                                                                                                                       hashDataMap.put( Number160.createHash( "3" ),
                                                                                                                                                                                        new HashData(
                                                                                                                                                                                                      testDataOld.getHash(),
                                                                                                                                                                                                      testDataNew ) );
                                                                                                                                                                       return storageRPC.compareAndPut( address,
                                                                                                                                                                                                        locationKey,
                                                                                                                                                                                                        domainKey,
                                                                                                                                                                                                        hashDataMap,
                                                                                                                                                                                                        new FutureSuccessEvaluatorOperation(),
                                                                                                                                                                                                        false,
                                                                                                                                                                                                        false,
                                                                                                                                                                                                        false,
                                                                                                                                                                                                        false,
    ...
    private void testForArray( Peer peer, Number160 locationKey, boolean find )
    {
        Collection<Number160> tmp = new ArrayList<Number160>();
        tmp.add( new Number160( 5 ) );
        Map<Number480, Data> test =
            peer.getPeerBean().getStorage().subMap( locationKey, new ShortString( "test" ).toNumber160(),
                                                    Number160.ZERO, Number160.MAX_VALUE );
        if ( find )
        {
            Assert.assertEquals( 1, test.size() );
            Assert.assertEquals( 44444,
                                 test.get( new Number480( new Number320( locationKey,
                                                                         new ShortString( "test" ).toNumber160() ),
    ...
    private Peer[] createNodes( Peer master, int nr, Random rnd )
        throws Exception
    {
    ...
    private Peer[] createNodes( Peer master, int nr )
        throws Exception
    {
