...
public class FutureDHT extends BaseFutureImpl<FutureDHT> implements FutureCleanup, BaseFutureRequest {
     ...
     * @param futureCreate
     *            The object to keep track of the futures created based on this future
     */
     ...
     */
    public void setDone(final Object attachement) {
        synchronized (lock) {
    ...
    /**
     * @return The attachement set via {@link #setDone(Object)}.
     */
     ...
     *            The location key
     * @param rawKeys
     *            The removed keys with information from which peer it has been removed
     */
    public void setRemovedKeys(final Number160 locationKey, final Number160 domainKey,
            final Map<PeerAddress, Collection<Number160>> rawKeys) {
        synchronized (lock) {
            if (!setCompletedAndNotify()) {
                return;
            }
    ...
    public void setReceivedData(final Number160 locationKey, final Number160 domainKey,
            final Map<PeerAddress, Map<Number160, Data>> rawData) {
        synchronized (lock) {
            if (!setCompletedAndNotify()) {
                return;
            }
     ...
     */
    public void setDirectData1(final Map<PeerAddress, ChannelBuffer> rawChannels) {
        synchronized (lock) {
            if (!setCompletedAndNotify()) {
                return;
            }
     ...
     */
    public void repeated(final FutureDHT futureDHT) {
     ...
     */
    public void addCleanup(final Cancellable cancellable) {
        synchronized (lock) {
    ...
    /**
     * 
     * @return True if the resources (connections) can be released early.
     */
