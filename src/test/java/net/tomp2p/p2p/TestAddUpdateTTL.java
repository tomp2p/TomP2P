...
public class TestAddUpdateTTL
{
        ...
        throws Exception
    {
        ...
        keyValueStore.put( "foo3".getBytes(),
                           Arrays.asList( "bla3a".getBytes(), "bla3b".getBytes(), "bla3c".getBytes() ) );
        ...
        throws InterruptedException
    {
        ...
        peer.add( new Number160( key ) ).setData( data ).setRoutingConfiguration( new RoutingConfiguration( 1, 0, 10, 1 ) ).setRequestP2PConfiguration( new RequestP2PConfiguration(
                                                                                                                                                                                     3,
                                                                                                                                                                                     5,
                                                                                                                                                                                     0 ) ).start().addListener( new BaseFutureAdapter<FutureDHT>()
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    @Override
