...
public class ExampleIndirectReplication
{
	...
	{
		Peer peer1 = new PeerMaker(new Number160(1)).setPorts(4001).setEnableIndirectReplication(true).makeAndListen();
		Peer peer2 = new PeerMaker(new Number160(2)).setPorts(4002).setEnableIndirectReplication(true).makeAndListen();
		Peer peer3 = new PeerMaker(new Number160(4)).setPorts(4003).setEnableIndirectReplication(true).makeAndListen();
