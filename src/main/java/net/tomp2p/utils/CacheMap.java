    ...
    extends LinkedHashMap<K, V>
{
     ...
     * 
     * @param maxEntries The number of entries that can be stored in this map
     * @param updateEntryOnInsert Set to true to update (overwrite) values. Set false to not overwrite the values if
