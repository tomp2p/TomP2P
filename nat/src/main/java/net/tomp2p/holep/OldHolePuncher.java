...
public class OldHolePuncher implements IPunchHole {
	...
	public OldHolePuncher(final Message message, final ChannelCreator channelCreator, Peer peer, int localPort, int remotePort, PeerAddress recipient) {
