...
public class TestPeerAddress
{
    ...
    @Test
    public void testPeerAddress3()
        throws UnknownHostException
    {
        PeerAddress pa1 =
            new PeerAddress( new Number160( "0x857e35a42e444522456" ), InetAddress.getByName( "192.168.230.230" ),
                             12345, 23456 );
        PeerAddress pa2 =
            new PeerAddress( new Number160( "0x657435a424444522456" ), InetAddress.getByName( "192.168.240.230" ),
                             34567, 45678 );
