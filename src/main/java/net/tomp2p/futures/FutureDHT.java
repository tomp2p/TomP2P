    ...
    implements FutureCleanup
{
     ...
     * @param evaluationScheme The scheme to evaluate results from multiple peers
     * @param futureCreate The object to keep track of the futures created based on this future
     ...
     * 
     * @param rawKeys The removed keys with information from which peer it has been removed
     */
    ...
    public void setStoredKeys( Number160 locationKey, Number160 domainKey, final Map<PeerAddress, Collection<Number160>> rawKeys, Map<PeerAddress, Collection<Number480>> rawKeys480 )
    {
        synchronized ( lock )
        {
            ...
            this.reason =
                minReached ? "Minimun number of results reached" : "Expected " + min + " result, but got " + size;
        }
        notifyListerenrs();
    }
     ...
     * 
     * @param rawData The keys and data that have been received with information from which peer it has been received.
     */
     ...
     * 
     * @param rawDigest The hashes of the content stored with information from which peer it has been received.
     */
     ...
     * 
     * @param rawChannels The raw data that have been sent directly with information on which peer it has been sent
     */
     ...
     * 
     * @param rawObjects The objects that have been sent directly with information on which peer it has been sent
     */
