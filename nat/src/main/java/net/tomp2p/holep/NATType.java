...
public enum NATType {
	UNKNOWN {
		@Override
		public HolePStrategy getHolePuncher(final Peer peer, int numberOfHoles, final int idleUDPSeconds,
	...
	public abstract HolePStrategy getHolePuncher(final Peer peer, int numberOfHoles,
