...
public class TestStorage {
    ...
    private void testAdd(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            FutureResponse fr = smmSender.add(recv1.getPeerAddress(), new Number160(33),
                    new ShortString("test").toNumber160(), dataSet, false, false, true, cc, false, null);
            ...
            SortedMap<Number480, Data> c = storeRecv.get(key.getLocationKey(), key.getDomainKey(), Number160.ZERO,
                    Number160.MAX_VALUE);
    ...
    private void testStorePut(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            tmp.put(new Number160(77), new Data(me1));
            tmp.put(new Number160(88), new Data(me2));
            fr = smmSender.put(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(), tmp,
                    false, false, false, cc, false, null);
            fr.awaitUninterruptibly();
            System.err.println(fr.getFailedReason());
            Assert.assertEquals(true, fr.isSuccess());
            Map<Number480, Data> result2 = storeRecv.subMap(key.getLocationKey(), key.getDomainKey(), Number160.ZERO,
                    Number160.MAX_VALUE);
    ...
    private void testComparePut(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            fr = smmSender.compareAndPut(recv1.getPeerAddress(), new Number160(33),
                    new ShortString("test").toNumber160(), hashDataMap, new FutureSuccessEvaluatorCommunication(),
                    false, false, false, false, cc, false);
            fr.awaitUninterruptibly();
    ...
    private void testStorePutIfAbsent(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            fr = smmSender.putIfAbsent(recv1.getPeerAddress(), new Number160(33),
                    new ShortString("test").toNumber160(), tmp, false, false, false, cc, false, null);
            fr.awaitUninterruptibly();
    ...
    private void testStorePutGet(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            fr.awaitUninterruptibly();
            // get
            fr = smmSender.get(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(),
    ...
    private void testStorePutGet2(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            fr.awaitUninterruptibly();
            // get
            fr = smmSender.get(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(), null,
    ...
    private void testStorePutRemoveGet(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            fr.awaitUninterruptibly();
            // remove
            fr = smmSender.remove(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(),
    ...
    private void testStoreGet(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureResponse fr = smmSender.add(recv1.getPeerAddress(), new Number160(33),
                    new ShortString("test").toNumber160(), tmp.values(), false, false, false, cc, false, null);
            fr.awaitUninterruptibly();
            // get
            fr = smmSender.get(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(), null,
                    null, null, false, false, false, false, cc, false);
    ...
    private void testBigStore2(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        Peer recv1 = null;
        try {
            sender = new PeerMaker(new Number160("0x50")).setP2PId(55).setPorts(2424)
                    .setMaxMessageSize(Integer.MAX_VALUE).makeAndListen();
            sender.getConfiguration().setIdleTCPMillis(Integer.MAX_VALUE);
            recv1 = new PeerMaker(new Number160("0x20")).setP2PId(55).setPorts(8088)
                    .setMaxMessageSize(Integer.MAX_VALUE).makeAndListen();
            ...
            fr.awaitUninterruptibly();
            Assert.assertEquals(true, fr.isSuccess());
            Data data = recv1.getPeerBean().getStorage()
                    .get(new Number160(33), new ShortString("test").toNumber160(), new Number160(77));
    ...
    public void testResponsibility() throws Exception {
        ...
        try {
            ...
            fcc.awaitUninterruptibly();
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureResponse fr = master.getStoreRPC().put(master.getPeerAddress(), location, location, dataMap, false,
                    false, false, cc, false, null);
            fr.awaitUninterruptibly();
    ...
    private void testBloomFilter(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            // get
            fr = smmSender.get(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(), null,
                    sbf, null, false, false, false, false, cc, false);
            fr.awaitUninterruptibly();
            Assert.assertEquals(true, fr.isSuccess());
            Message m = fr.getResponse();
            Map<Number160, Data> stored = m.getDataMap();
    ...
    private void testBloomFilterDigest(StorageGeneric storeSender, StorageGeneric storeRecv) throws Exception {
        ...
        try {
            ...
            // get
            fr = smmSender.get(recv1.getPeerAddress(), new Number160(33), new ShortString("test").toNumber160(), null,
                    sbf, null, false, true, false, false, cc, false);
            fr.awaitUninterruptibly();
            sender.getConnectionBean().getConnectionReservation().release(cc);
            Assert.assertEquals(true, fr.isSuccess());
            Message m = fr.getResponse();
