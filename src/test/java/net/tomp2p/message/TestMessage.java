...
public class TestMessage
{
     ...
     * saturate an 86mbit/s link. The larger the message, the more bandwidth we use.
     * 
     * @throws Exception
     */
    @Test
    ...
    private void compareMessage( Message m1, Message m2 )
    {
        ...
        if ( m1.getDataMap() != null && m2.getDataMap() != null )
        {
            ...
            while ( it1.hasNext() && it2.hasNext() )
            {
                ...
                {
                    Assert.assertEquals( d1.getData()[d1.getOffset() + i], d2.getData()[d2.getOffset() + i] );
                }
            }
        }
    ...
    public void testOrder()
    {
        ...
        PeerMap routingMap = new PeerMap( b1, 2, 60 * 1000, 3, new int[0], 100, new DefaultMapHandler( false ) );
