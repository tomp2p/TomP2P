 ...
 * 
 */
public class HolePRPCLegacy extends DispatchHandler {

	private static final Logger LOG = LoggerFactory.getLogger(HolePRPCLegacy.class);
	private final Peer peer;

	public HolePRPCLegacy(final Peer peer) {
