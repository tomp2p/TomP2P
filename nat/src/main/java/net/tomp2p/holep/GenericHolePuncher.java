...
public class GenericHolePuncher {
	...
	public GenericHolePuncher(final Peer peer, final int numberOfHoles, final int idleUDPSeconds, final Message originalMessage) {
		this.peer = peer;
	...
	public FutureDone<FutureResponse> initiateHolePunch(final SimpleChannelInboundHandler<Message> originalHandler,
		...
		FutureDone<List<ChannelFuture>> fDoneChannelFutures = createChannelFutures(originalChannelCreator, originalHandler,
				originalFutureResponse, prepareHandlers(originalFutureResponse));
...
//					fDone.done(msg);
	...
	private final FutureDone<List<ChannelFuture>> createChannelFutures(final ChannelCreator originalChannelCreator,
			final SimpleChannelInboundHandler<Message> originalHandler, final FutureResponse originalFutureResponse,
