    ...
    implements Comparable<Number160>
{
     ...
     * 
     * @param val The value to copy to the backing array. Since this class stores 160bit numbers, the array needs to be
     ...
     * 
     * @param random The object to create pseudo random numbers. For testing and debugging, the seed in the random class
