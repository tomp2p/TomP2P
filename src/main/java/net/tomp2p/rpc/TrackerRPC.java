    ...
    extends ReplyHandler
{
    ...
    public FutureResponse addToTracker( final PeerAddress remotePeer, final Number160 locationKey,
                                        final Number160 domainKey, final byte[] attachement, boolean signMessage,
    ...
    public FutureResponse addToTracker( final PeerAddress remotePeer, final Number160 locationKey,
                                        final Number160 domainKey, final byte[] attachement, int offset, int legth,
                                        ...
                                        ChannelCreator channelCreator, boolean forceUDP, boolean forceTCP )
    {
        ...
        if ( ( attachement != null || forceTCP ) && !forceUDP )
        {
            ...
            final TrackerRequestTCP<FutureResponse> requestHandler =
                new TrackerRequestTCP<FutureResponse>( futureResponse, getPeerBean(), getConnectionBean(), message,
        ...
        {
            FutureResponse futureResponse = new FutureResponse( message );
            final TrackerRequestUDP<FutureResponse> requestHandler =
                new TrackerRequestUDP<FutureResponse>( futureResponse, getPeerBean(), getConnectionBean(), message,
                                                       locationKey, domainKey );
    ...
    private class TrackerRequestTCP<K extends FutureResponse>
    ...
    private class TrackerRequestUDP<K extends FutureResponse>
