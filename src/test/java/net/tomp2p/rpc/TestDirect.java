...
public class TestDirect
{
    ...
    @Test
    public void testDirectMessage1()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
    ...
    @Test
    public void testDirectReconnect()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            sender =
                new PeerMaker( new Number160( "0x50" ) ).setP2PId( 55 ).setPorts( 2424 ).setEnableMaintenance( false ).makeAndListen();
            recv1 =
                new PeerMaker( new Number160( "0x20" ) ).setP2PId( 55 ).setPorts( 8088 ).setEnableMaintenance( false ).makeAndListen();
            recv1.setObjectDataReply( new ObjectDataReply()
            {
                @Override
                public Object reply( PeerAddress sender, Object request )
    ...
    @Test
    public void testDirectReconnectParallel()
        throws Exception
    {
        Peer sender = null;
        Peer recv1 = null;
