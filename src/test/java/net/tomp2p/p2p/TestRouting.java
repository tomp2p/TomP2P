...
public class TestRouting
{
    ...
    {
        // setup
        PeerMap test = new PeerMap( new Number160( 77 ), 2, 60 * 1000, 3, new int[0], 100, new DefaultMapAcceptHandler( false ) );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureRouting fr =
                peers[0].getDistributedRouting().route( peers[6].getPeerID(), null, null, Type.REQUEST_2, 0, 0, 0, 100,
                                                        2, false, cc );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureRouting fr =
                peers[0].getDistributedRouting().route( peers[6].getPeerID(), null, null, Type.REQUEST_1, 0, 0, 0, 100,
                                                        2, false, cc );
            Utils.addReleaseListenerAll( fr, peers[0].getConnectionBean().getConnectionReservation(), cc );
            fr.awaitUninterruptibly();
            // do verification
    ...
    @Test
    public void testRouting2_detailed()
        throws Exception
    {
        Peer[] peers = null;
        try
    ...
    @Test
    public void testRouting3_detailed()
        throws Exception
    {
        Peer[] peers = null;
        try
    ...
    private Peer[] createSpecialPeers( int nr )
        throws Exception
    {
    ...
    @Test
    public void testPerfectRouting()
        throws Exception
    {
    ...
    @Test
    public void testRoutingBulkTCP()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureRouting fr =
                peers[500].getDistributedRouting().route( peers[20].getPeerID(), null, null, Type.REQUEST_2, 0, 0, 0,
                                                          100, 1, false, cc );
    ...
    @Test
    public void testRoutingBulkUDP()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            final ChannelCreator cc = fcc.getChannelCreator();
            FutureRouting fr =
                peers[500].getDistributedRouting().route( peers[20].getPeerID(), null, null, Type.REQUEST_1, 0, 0, 0,
                                                          100, 1, false, cc );
            Utils.addReleaseListenerAll( fr, peers[500].getConnectionBean().getConnectionReservation(), cc );
            fr.awaitUninterruptibly();
            // do verification
    ...
    @Test
    public void testRoutingConcurrentlyTCP()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            for ( int i = 0; i < peers.length; i++ )
            {
                ...
                final ChannelCreator cc = fcc.getChannelCreator();
                FutureRouting frr =
                    peers[( ( i * 7777 ) + 1 ) % peers.length].getDistributedRouting().route( peers[( ( i * 3333 ) + 1 )
                                                                                                  % peers.length].getPeerID(),
                                                                                              null, null,
                                                                                              Type.REQUEST_2, 0, 0, 0,
                                                                                              100, 1, false, cc );
    ...
    @Test
    public void testRoutingConcurrentlyTCP2()
        throws Exception
    {
        Peer master = null;
        try
    ...
    @Test
    public void testRoutingConcurrentlyUDP()
        throws Exception
    {
        Peer master = null;
        try
    ...
    @Test
    public void testRoutingConcurrentlyUDP2()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            for ( int i = 0; i < peers.length; i++ )
            {
                ...
                final ChannelCreator cc = fcc.getChannelCreator();
                FutureRouting frr =
                    peers[peerNr].getDistributedRouting().route( peers[( ( i * 3333 ) + 1 ) % peers.length].getPeerID(),
                                                                 null, null, Type.REQUEST_1, 0, 1, 0, 100, 2, false, cc );
    ...
    @Test
    public void testRoutingBootstrap1()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            for ( int i = 1; i < peers.length; i++ )
            {
                ...
                fcc.awaitUninterruptibly();
                final ChannelCreator cc = fcc.getChannelCreator();
                FutureWrapper<FutureRouting> fm =
                    peers[i].getDistributedRouting().bootstrap( peerAddresses, 5, 100, 100, 1, true, false, cc );
    ...
    @Test
    public void testRoutingBootstrap2()
        throws Exception
    {
        Peer master = null;
        try
        {
            ...
            for ( int i = 1; i < peers.length; i++ )
            {
                ...
                final ChannelCreator cc = fcc.getChannelCreator();
                FutureWrapper<FutureRouting> fm =
                    peers[i].getDistributedRouting().bootstrap( peerAddresses, 5, 100, 100, 1, false, false, cc );
                Utils.addReleaseListenerAll( fm, peers[i].getConnectionBean().getConnectionReservation(), cc );
                fm.awaitUninterruptibly();
                // do verification
                Assert.assertEquals( true, fm.isSuccess() );
        ...
        throws Exception
    {
        ...
        for ( int k = 0; k < 100; k++ )
        {
            ...
            try
            {
                ...
                final ChannelCreator cc = fcc.getChannelCreator();
                FutureRouting frr =
                    peers[50].getDistributedRouting().route( find, null, null, Type.REQUEST_1, Integer.MAX_VALUE, 5,
                                                             10, 20, 2, false, cc );
    ...
    @Test
    public void testBadDistribution()
        throws Exception
    {
        Peer[] peers = null;
        try
