...
public class TestTaskRPC
{
        ...
        throws Exception
    {
        ...
        {
            peer1 =
                new PeerMaker( new Number160( rnd ) ).setWorkerThreads( 1 ).setPorts( 4001 ).setEnableTask( true ).makeAndListen();
            peer2 =
                new PeerMaker( new Number160( rnd ) ).setWorkerThreads( 1 ).setPorts( 4002 ).setEnableTask( true ).makeAndListen();
            FutureChannelCreator futureChannelCreator =
                peer1.getConnectionBean().getConnectionReservation().reserve( 1 );
            ...
            FutureResponse futureResponse =
                peer1.getTaskRPC().sendTask( peer1.getPeerAddress(), futureChannelCreator.getChannelCreator(), taskId,
                                             dataMap, new MyWorker1(), null, false, false );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            peer2 =
                new PeerMaker( new Number160( rnd ) ).setWorkerThreads( 1 ).setPorts( 4002 ).setEnableTask( true ).makeAndListen();
            FutureChannelCreator futureChannelCreator =
                peer1.getConnectionBean().getConnectionReservation().reserve( 5 );
            futureChannelCreator.awaitUninterruptibly();
            ...
            Map<Number160, Data> dataMap = new HashMap<Number160, Data>();
            dataMap.put( new Number160( 22 ), new Data( "testme" ) );
            FutureResponse futureResponse1 =
                peer1.getTaskRPC().sendTask( peer1.getPeerAddress(), futureChannelCreator.getChannelCreator(), taskId1,
                                             dataMap, new MyWorker2(), null, false, false );
            futureResponse1.awaitUninterruptibly();
            FutureResponse futureResponse2 =
                peer1.getTaskRPC().sendTask( peer1.getPeerAddress(), futureChannelCreator.getChannelCreator(), taskId2,
                                             dataMap, new MyWorker2(), null, false, false );
            futureResponse2.awaitUninterruptibly();
            FutureResponse futureResponse3 =
                peer1.getTaskRPC().sendTask( peer1.getPeerAddress(), futureChannelCreator.getChannelCreator(), taskId3,
                                             dataMap, new MyWorker2(), null, false, false );
            ...
            taskIDs.add( taskId2 );
            taskIDs.add( taskId3 );
            FutureResponse futureResponse4 =
                peer1.getTaskRPC().taskStatus( peer1.getPeerAddress(), futureChannelCreator.getChannelCreator(),
                                               taskIDs, false );
            ...
            Thread.sleep( 1000 );
            FutureResponse futureResponse5 =
                peer1.getTaskRPC().taskStatus( peer1.getPeerAddress(), futureChannelCreator.getChannelCreator(),
                                               taskIDs, false );
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureAsyncTask futureAsyncTask =
                peer1.getAsyncTask().submit( peer2.getPeerAddress(), futureChannelCreator.getChannelCreator(), taskId,
                                             dataMap, new MyWorker3(), false, false );
    ...
    @Test
    public void testRPCAsyncFailed()
        throws Exception
    {
        Peer peer1 = null;
        Peer peer2 = null;
