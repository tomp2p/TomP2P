...
public class TestNeighbor
{
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            FutureResponse fr =
                neighbors2.closeNeighbors( sender.getPeerAddress(), new Number160( "0x30" ), null, null,
                                           Type.REQUEST_2, cc, false );
    ...
    private PeerAddress[] createDummyAddress( int size )
    ...
    private PeerAddress createAddress( int iid )
        throws UnknownHostException
    {
