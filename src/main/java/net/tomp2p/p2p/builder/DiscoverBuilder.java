...
public class DiscoverBuilder
{
    ...
    final private static FutureDiscover FUTURE_DISCOVER_SHUTDOWN =
        new FutureDiscover().setFailed( "Peer is shutting down" );
     ...
     * 
     * @param peerAddress The peer address. Since pings are used the peer ID can be Number160.ZERO
                    ...
                    if ( tmp.size() == 1 )
                    {
                        ...
                        if ( !peer.getPeerAddress().getInetAddress().equals( seenAs.getInetAddress() ) )
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    serverAddress =
                                        serverAddress.changePorts( peer.getBindings().getOutsideUDPPort(),
