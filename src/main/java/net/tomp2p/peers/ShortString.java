    ...
    implements Comparable<ShortString>
{
     ...
     * 
     * @param s1 The string
     * @throws UnsupportedEncodingException if UTF-8 is not available. If this is the case, then we have a problem...
     */
     ...
     * @throws UnsupportedEncodingException If this is the case, then we have a problem...
     */
    public ShortString( final Number160 number160 )
