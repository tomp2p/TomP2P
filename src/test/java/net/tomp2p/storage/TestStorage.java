...
public class TestStorage {
    ...
    private void testPublicKeyDomain(StorageGeneric storage) throws Exception {
        ...
        PutStatus result1 = storage.put(locationKey, domainKey, content3, new Data("test4"), pair1.getPublic(), false,
                false);
        Assert.assertEquals(PutStatus.OK, result1);
        PutStatus result3 = storage.put(locationKey, domainKey, content3, new Data("test6"), pair1.getPublic(), false,
                true);
        Assert.assertEquals(PutStatus.OK, result3);
        // domain is protected by pair1
        PutStatus result2 = storage.put(locationKey, domainKey, content3, new Data("test5"), pair2.getPublic(), false,
                true);
